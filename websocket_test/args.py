...
parser.add_argument('clients', type=int, help='How many client you needs to start?')
...
parser.add_argument('-a', type=int, default=0, help='How many packets we sent before stop?')
